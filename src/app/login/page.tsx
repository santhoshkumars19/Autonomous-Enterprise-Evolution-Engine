...
export default function LoginPage() {
  ...
  const handleMicrosoftSubmit = async (emailToSubmit: string) => {
            ...
            <CardContent>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  ...
                  className="text-xs flex items-center justify-center gap-2 py-2.5 border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800 cursor-pointer"
                >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 backdrop-blur-md p-4">
          <div className="w-full max-w-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl p-6 space-y-5 relative animate-in fade-in zoom-in duration-200">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1.5">
                {[
                  ...
                  <button
                    key={acc.email}
                    onClick={() => handleMicrosoftSubmit(acc.email)}
            ...
            >
              ...
              >
                {isSocialSubmitting ? "Signing in..." : "Continue with Microsoft"}
              </Button>
            </form>
          </div>
        </div>
